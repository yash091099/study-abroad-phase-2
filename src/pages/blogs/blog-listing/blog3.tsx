...
const Blog3: FunctionComponent<Blog3Type> = ({ propWidth }) => {
  ...
  return (
    <div   onClick={()=>{navigate('/blog-details')}}
      className=" card w-[382px] rounded-xl bg-white box-border flex flex-col items-start justify-start max-w-full text-left text-sm text-black2 font-gilroy border-[1px] border-solid border-silver-200"
      style={blogStyle}
    >
      <div className="self-stretch h-[260px] flex flex-row items-start justify-end p-4 box-border relative">
        <img
          ...
          src="/joiner@2x.png"
        />
        <div style={{cursor:"pointer"}} className="h-8 w-8 rounded-lg bg-lavenderblush box-border flex flex-row items-start justify-start py-[9px] px-2 gap-[10px] z-[1] border-[1px] border-solid border-gainsboro-300">
          <img
      ...
      <div className="self-stretch flex flex-col items-start justify-center p-6 text-xs text-grey-grey-04 font-light-basic-typography-paragraph-small">
        <div className="self-stretch flex flex-col items-start justify-start gap-[8px]">
          ...
          <h3 className="m-0 self-stretch relative text-lg leading-[140%] font-normal font-gilroy text-grey-grey-01">
