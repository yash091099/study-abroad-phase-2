...
const Blog4: FunctionComponent = () => {
  return (
    <div className="rounded-xl bg-white box-border flex flex-col items-start justify-start max-w-full shrink-0 text-left text-sm text-black2 font-gilroy border-[1px] border-solid border-silver-200">
